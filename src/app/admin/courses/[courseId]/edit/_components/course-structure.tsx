...
// Import the hooks
import { CourseDataType, useReorderChapters, useReorderLessons } from '@/data/admin/hooks/use-admin';
...
export default function CourseStructure({data}:{data:CourseDataType}) {
